...
$(INDEX_FILE): $(SOURCE_DIR)/src/index-pages.sh $(SCRIPTS_DIR)/gnu/index-terms.sh $(DOCUMENTS_DIR)
	...
	$(SCRIPTS_DIR)/gnu/index-terms.sh Builtin $@ $(DOCUMENTS_DIR)/Builtin-Index.html
	$(SCRIPTS_DIR)/gnu/index-terms.sh Word $@ $(DOCUMENTS_DIR)/Reserved-Word-Index.html
	$(SCRIPTS_DIR)/gnu/index-terms.sh Variable $@ $(DOCUMENTS_DIR)/Variable-Index.html
	$(SCRIPTS_DIR)/gnu/index-terms.sh Function $@ $(DOCUMENTS_DIR)/Function-Index.html
