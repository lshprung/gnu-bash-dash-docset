...
$(INDEX_FILE): src/index-page.sh src/index-terms.sh $(DOCUMENTS_DIR)
	...
	src/index-terms.sh Builtin $@ $(DOCUMENTS_DIR)/Builtin-Index.html
	src/index-terms.sh Word $@ $(DOCUMENTS_DIR)/Reserved-Word-Index.html
	src/index-terms.sh Variable $@ $(DOCUMENTS_DIR)/Variable-Index.html
	src/index-terms.sh Function $@ $(DOCUMENTS_DIR)/Function-Index.html
